---
layout: post.html
title: "Interesing Thingys 23"
date: 2012-07-06 08:17
comments: false
published: true
...
- [blog.izs.me: On ES 6 Modules](http://blog.izs.me/post/25906678790/on-es-6-modules)
- [Mozilla's Dev Derby Contest for July: Build Something Without JavaScript](http://developer.mozilla.org/en-US/demosdevderby)
...
- [Percentage Loader: jQuery Plugin to Display Progress](http://widgets.better2web.com/loader/)
- [Radi 0.9 Adds Support for Realtime WebGL Visual Effects](http://radiapp.com/webgl)
- [Gamecore.js: increase javascript game performance by 1200% | Playcraft](http://blog.getplaycraft.com/gamecore-js/)
...
### HTML(5)
- [New E-Book: The Truth About HTML5 (For Web Designers)](http://www.truthabouthtml5.com/)
- [Google I/O Recap from a HTML5 Game Development Perspective](http://www.html5gamedevelopment.org/html5-news/2012-06-google-io-recap-from-a-html5-game-developer-perspect)
- [Turning the Web Up to 11: The Web Audio API](http://webaudio-io2012.appspot.com/)
- [Crunching Megapixels in WebGL](http://lacquer.fi/pauli/blog/2012/06/crunching-megapixels-in-webgl/)
- [Creating a Slider Control with the HTML5 Range Input](http://www.developerdrive.com/2012/07/creating-a-slider-control-with-the-html5-range-input/)
- [HTML5 Validator with Error Filters](http://validator.keegan.st/)
- [Cinderblock: A Stripped Down HTML/CSS Boilerplate for Starting Any Project](http://dhgamache.github.com/Cinderblock/)

### Web general
- [The Web Can Do That!?](http://www.youtube.com/watch?v=X_ek1wSe66o)
- [Better Web App Development Through Tooling with Paul Irish](http://www.youtube.com/watch?v=Mk-tFn2Ix6g)
- [Yeoman: Google's Opinionated Stack'o'Tools for Webapp Developers](http://yeoman.io/)
...
### Fun
- [Internet Explorer 6 as a Chat Server](http://www.getbridge.com/blog/ie6chatserver)
- [Matraka: A Demo in 1005 Bytes](http://www.p01.org/releases/MATRAKA/matraka.png.html?tc)
